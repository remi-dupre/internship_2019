...
\begin{document}
    ...
    \subsection{Regular expressions and regular languages}
      ...
      \subsubsection{Regular expressions}%
        ...
        \paragraph{Extra notation}
          ...
          % TODO: \pierre{You are mixing up regular expressions written in
        ...
        \begin{algorithm}[H]
          ...
          \begin{algorithmic}[1]
            ...
            \For{$q$ \textbf{in} $F$}
              ...
              \If{there are no marker transitions that start from $v$}
  ...
  \section{Performance of the algorithm}
    ...
    \subsection{Implementation}
      ...
      |d|)$ factor but allows to update \textproc{Reach} matrices less often,
    ...
    \subsection{Limitations of existing tools}
      ...
      Some of these tools
      % \pierre{Which tools? You really need to discuss existing tools in detail}
    ...
    \subsection{Results}
      ...
      % \pierre{Again, again, again, they need to be described}
      ...
      \begin{figure}%
        ...
        % \pierre{Same label as previous figure???}
